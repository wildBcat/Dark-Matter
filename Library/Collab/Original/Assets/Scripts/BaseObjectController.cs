...
public class BaseObjectController : MonoBehaviour
{
    ...
    [Tooltip("Sets the color the sprite will flash when damage is assigned. If this isn't set then the mat will take on the color of the sprite.")]
    [SerializeField] Color collideColor = default;

    [Tooltip("Sets the color of the mat that is placed over the sprite")]
    private Material matWhite;

    // A variable that stores the original material color
